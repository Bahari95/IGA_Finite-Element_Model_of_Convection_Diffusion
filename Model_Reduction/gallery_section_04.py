...
#---1 : Assembles mass matrix 3D
@types('int', 'int', 'int', 'int', 'int', 'int', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'double[:,:,:,:]', 'double[:,:,:,:]', 'double[:,:,:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:,:,:,:,:]')
def assemble_matrix_ex04(ne1, ne2, ne3,
                        p1, p2, p3,
                        spans_1, spans_2, spans_3, 
                        basis_1, basis_2, basis_3,
                        weights_1, weights_2, weights_3,
                            ...
                            for g1 in range(0, k1):
                               for g2 in range(0, k2):
                                  for g3 in range(0, k3):
                                     ...
                                     matrix[p1+i1, p2+i2, p3+i3, p1+j1-i1, p2+j2-i2, p3+j3-i3] += bi_0 * bj_0 * wvol
    # ...
...
@types('int', 'int', 'int', 'int', 'int', 'int', 'int[:]', 'int[:]', 'int[:]', 'double[:,:,:,:]', 'double[:,:,:,:]', 'double[:,:,:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:,:]')
def assemble_vector_ex02(ne1, ne2, ne3, p1, p2, p3, spans_1, spans_2, spans_3,  basis_1, basis_2, basis_3,  weights_1, weights_2, weights_3, points_1, points_2, points_3, rhs):
...
#---1 : Assemble rhs Poisson
@types('int', 'int', 'int', 'int', 'int', 'int', 'int[:]', 'int[:]', 'int[:]', 'double[:,:,:,:]', 'double[:,:,:,:]', 'double[:,:,:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'real', 'double[:,:,:]')
def assemble_vector_ex03(ne1, ne2, ne3, p1, p2, p3, spans_1, spans_2, spans_3,  basis_1, basis_2, basis_3,  weights_1, weights_2, weights_3, points_1, points_2, points_3, Re_Pe, rhs):
                ...
                for g1 in range(0, k1):
                   for g2 in range(0, k2):
                      for g3 in range(0, k3):
                            ...
                            #.. Test 1
                            f    = (3.*pi**2*sin(pi*x)*sin(pi*y)*sin(pi*z))/Re_Pe + v_b1*pi*cos(pi*x)*sin(pi*y)*sin(pi*z) + v_b2*pi*sin(pi*x)*cos(pi*y)*sin(pi*z) + v_b3*pi*sin(pi*x)*sin(pi*y)*cos(pi*z)
